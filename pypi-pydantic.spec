...
Source0  : https://files.pythonhosted.org/packages/93/a3/698b87a4d4d303d7c5f62ea5fbf7a79cab236ccfbd0a17847b7f77f8163e/pydantic-2.11.1.tar.gz
...
%prep
%setup -q -n pydantic-2.11.1
cd %{_builddir}/pydantic-2.11.1
pushd ..
cp -a pydantic-2.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743432070
