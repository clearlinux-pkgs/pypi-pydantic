...
Source0  : https://files.pythonhosted.org/packages/8c/99/d0a5dca411e0a017762258013ba9905cd6e7baa9a3fd1fe8b6529472902e/pydantic-2.8.2.tar.gz
...
%prep
%setup -q -n pydantic-2.8.2
cd %{_builddir}/pydantic-2.8.2
pushd ..
cp -a pydantic-2.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720105267
