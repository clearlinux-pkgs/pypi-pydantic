...
Source0  : https://files.pythonhosted.org/packages/10/2e/ca897f093ee6c5f3b0bee123ee4465c50e75431c3d5b6a3b44a47134e891/pydantic-2.11.3.tar.gz
...
%prep
%setup -q -n pydantic-2.11.3
cd %{_builddir}/pydantic-2.11.3
pushd ..
cp -a pydantic-2.11.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744120580
