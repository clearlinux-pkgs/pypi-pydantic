...
Source0  : https://files.pythonhosted.org/packages/28/59/5d2fc3499d9ce8ce48ee7e00f043d5cc429a9198bd96c3512809428ade15/pydantic-1.10.5.tar.gz
...
%prep
%setup -q -n pydantic-1.10.5
cd %{_builddir}/pydantic-1.10.5
pushd ..
cp -a pydantic-1.10.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676517017
