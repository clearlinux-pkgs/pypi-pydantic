...
Source0  : https://files.pythonhosted.org/packages/f0/86/8ce9040065e8f924d642c58e4a344e33163a07f6b57f836d0d734e0ad3fb/pydantic-2.11.5.tar.gz
...
%prep
%setup -q -n pydantic-2.11.5
cd %{_builddir}/pydantic-2.11.5
pushd ..
cp -a pydantic-2.11.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748010046
