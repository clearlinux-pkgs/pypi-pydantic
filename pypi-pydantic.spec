...
Source0  : https://files.pythonhosted.org/packages/a9/b7/d9e3f12af310e1120c21603644a1cd86f59060e040ec5c3a80b8f05fae30/pydantic-2.9.2.tar.gz
...
%prep
%setup -q -n pydantic-2.9.2
cd %{_builddir}/pydantic-2.9.2
pushd ..
cp -a pydantic-2.9.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726592441
