...
Source0  : https://files.pythonhosted.org/packages/4b/de/38b517edac45dd022e5d139aef06f9be4762ec2e16e2b14e1634ba28886b/pydantic-2.6.4.tar.gz
...
%prep
%setup -q -n pydantic-2.6.4
cd %{_builddir}/pydantic-2.6.4
pushd ..
cp -a pydantic-2.6.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710254932
