...
Source0  : https://files.pythonhosted.org/packages/1f/74/0d009e056c2bd309cdc053b932d819fcb5ad3301fc3e690c097e1de3e714/pydantic-2.7.1.tar.gz
...
%prep
%setup -q -n pydantic-2.7.1
cd %{_builddir}/pydantic-2.7.1
pushd ..
cp -a pydantic-2.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713883613
