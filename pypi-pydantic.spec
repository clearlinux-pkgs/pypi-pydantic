...
Source0  : https://files.pythonhosted.org/packages/53/17/34e54e352f6a3d304044e52d5ddd5cd621a62ec8fb7af08cc73af65dd3e1/pydantic-1.10.4.tar.gz
...
%prep
%setup -q -n pydantic-1.10.4
cd %{_builddir}/pydantic-1.10.4
pushd ..
cp -a pydantic-1.10.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672417830
