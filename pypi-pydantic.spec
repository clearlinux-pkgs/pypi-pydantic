...
Source0  : https://files.pythonhosted.org/packages/e9/ed/b7a827705eb2490ffb6752a0302e58611ea743d7140e7dafaedee2afc953/pydantic-2.7.2.tar.gz
...
%prep
%setup -q -n pydantic-2.7.2
cd %{_builddir}/pydantic-2.7.2
pushd ..
cp -a pydantic-2.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717011546
