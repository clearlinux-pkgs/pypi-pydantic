...
Source0  : https://files.pythonhosted.org/packages/b0/41/832125a41fe098b58d1fdd04ae819b4dc6b34d6b09ed78304fd93d4bc051/pydantic-2.11.2.tar.gz
...
%prep
%setup -q -n pydantic-2.11.2
cd %{_builddir}/pydantic-2.11.2
pushd ..
cp -a pydantic-2.11.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743688632
