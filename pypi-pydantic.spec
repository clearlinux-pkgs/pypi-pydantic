...
Source0  : https://files.pythonhosted.org/packages/cd/fc/70fe71ff78f680d584eba9c55a30092f6ef0b9cf0c75a74bd35a24151a83/pydantic-2.7.0.tar.gz
...
%prep
%setup -q -n pydantic-2.7.0
cd %{_builddir}/pydantic-2.7.0
pushd ..
cp -a pydantic-2.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712937709
