...
Version  : 1.10.1
Release  : 7
URL      : https://files.pythonhosted.org/packages/d5/eb/d5ee9e58b2a4608c320fc72e5d471ba0cd949e8ef6f2689d30d1bd782d9f/pydantic-1.10.1.tar.gz
...
%prep
%setup -q -n pydantic-1.10.1
cd %{_builddir}/pydantic-1.10.1
pushd ..
cp -a pydantic-1.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661968006
