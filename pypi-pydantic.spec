...
Source0  : https://files.pythonhosted.org/packages/6a/c7/ca334c2ef6f2e046b1144fe4bb2a5da8a4c574e7f2ebf7e16b34a6a2fa92/pydantic-2.10.5.tar.gz
...
%prep
%setup -q -n pydantic-2.10.5
cd %{_builddir}/pydantic-2.10.5
pushd ..
cp -a pydantic-2.10.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736435034
