...
Source0  : https://files.pythonhosted.org/packages/77/ab/5250d56ad03884ab5efd07f734203943c8a8ab40d551e208af81d0257bf2/pydantic-2.11.4.tar.gz
...
%prep
%setup -q -n pydantic-2.11.4
cd %{_builddir}/pydantic-2.11.4
pushd ..
cp -a pydantic-2.11.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746026046
