...
Source0  : https://files.pythonhosted.org/packages/8b/7b/23dc30fba5793d7be3307f33bebb36e08f78f8af9c03fce608833f01bebd/pydantic-2.8.0.tar.gz
...
%prep
%setup -q -n pydantic-2.8.0
cd %{_builddir}/pydantic-2.8.0
pushd ..
cp -a pydantic-2.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720051896
