...
Source0  : https://files.pythonhosted.org/packages/73/27/a17cc261bb974e929aa3b3365577e43c1c71c3dcd8669250613a7135cb8f/pydantic-2.6.1.tar.gz
...
%prep
%setup -q -n pydantic-2.6.1
cd %{_builddir}/pydantic-2.6.1
pushd ..
cp -a pydantic-2.6.1 buildavx2
popd
pushd ..
cp -a pydantic-2.6.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707148950
