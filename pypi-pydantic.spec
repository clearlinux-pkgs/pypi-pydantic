...
Source0  : https://files.pythonhosted.org/packages/82/2a/4ba34614269b1e12a28b9fe54710983f5c3679f945797e86250c6269263f/pydantic-2.11.0.tar.gz
...
%prep
%setup -q -n pydantic-2.11.0
cd %{_builddir}/pydantic-2.11.0
pushd ..
cp -a pydantic-2.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743172604
