...
Source0  : https://files.pythonhosted.org/packages/3c/6c/5d3b1c9615726a69a9a1f992e63f8fd0a2d19ae726c15eb9154fdce48217/pydantic-2.6.3.tar.gz
...
%prep
%setup -q -n pydantic-2.6.3
cd %{_builddir}/pydantic-2.6.3
pushd ..
cp -a pydantic-2.6.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709079755
